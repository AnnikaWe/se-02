...
public class ProjectTester {
  ...
  public void test_simple_example_10() {
	  assertFalse(simple_example.isWellSorted(new String[] {"A","C","D","D"}));
  }
  
  @Test
  public void test_simple_example_11(){
	  assertFalse(simple_example.isWellSorted(new String[] {"A","B","C","D","Z"}));
  }
  
  //Ü2
  @Test
  public void test_new_example_12() {
	  assertTrue(simple_example.isWellSorted(new String[] {"a"}));
  }
